...
namespace LightBlue.MultiHost.Core.ViewModel
{
    public static class ImageUtil
    {
        public static ImageSource ColourImage(string resource, SolidColorBrush brush)
        {
            ...
            StreamResourceInfo x = System.Windows.Application.GetResourceStream(uri);
            BitmapDecoder dec = BitmapDecoder.Create((Stream) x.Stream, BitmapCreateOptions.None, BitmapCacheOption.Default);
