...
using LightBlue.MultiHost.Core.RoleStates;
...
namespace LightBlue.MultiHost.Core
{
    public class Role : INotifyPropertyChanged
    {
        ...
        public Role(RoleConfiguration role, INotificationHub notificationHub)
        {
            Config = role;
        ...
        {
            State.Crashed();
            _notificationHub.Notify(Config.Title, "This role has crashed and will be recycled", OnPanic);
        }
        ...
        {
            await Task.Run((Action) (() => _current.Dispose()));
            _current = null;
            OnStopped();
        }
